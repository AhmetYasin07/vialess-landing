...
export function HomePricing({ onNavigateToPricing }: { onNavigateToPricing: () => void }) {
  ...
  const segments = [
    ...
    },
    {
      ...
      audience: 'Profesyoneller',
      description: 'Profesyoneller ve bireysel girişimciler için gelişmiş özellikler. Sınırsız profil, gelişmiş analitik ve reklamsız deneyim.',
      price: '$5.99',
      priceLabel: '/ay',
      features: [
        ...
        'E-posta imzası ve Sanal arka plan',
        'Kartvizit dışa aktarma',
        'Öncelikli destek',
      ],
      cta: 'Pro Planı Seç',
