...
function ReferenceCard({ testimonial }: ReferenceCardProps) {
  ...
  return (
    <div className="group relative bg-white p-4 rounded-xl border border-gray-100 hover:border-[#6c63ff]/30 shadow-sm hover:shadow-md transition-all duration-300 flex items-center gap-4 h-[72px] w-[280px] flex-shrink-0 mx-2">
      <div className={`w-12 h-12 flex-shrink-0 flex items-center justify-center ${testimonial.image ? '' : 'bg-gray-50 rounded-lg group-hover:bg-[#6c63ff] transition-colors duration-300'}`}>
        {testimonial.image ? (
          <ImageWithFallback 
    ...
    <section className="py-20 bg-white overflow-hidden">
      <div className="w-full">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center mb-16">
          <h2 className="text-gray-900 mb-4">Referanslarımız</h2>
          <p className="text-gray-600 max-w-3xl mx-auto">
            Vialess'i tercih eden firmalar, dijital kartvizit ve NFC çözümlerimizle bağlantı kurma şeklini dönüştürüyor. İşte güvenen kurumlarımızdan bazıları.
          </p>
        </div>
