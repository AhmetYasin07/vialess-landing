export const blogPosts = [
  ...
  },
  {
    ...
    author: 'Zeynep Kaya',
    content: `
      <p>Fiziksel kartvizitlerin bitmek bilmeyen sorunu: "Kartım bitti" veya "Yanımda getirmeyi unutmuşum". Dijital dünyada bu bahanelere yer yok.</p>

      <h3>Hızlı ve Etkili Bağlantı</h3>
      <p>Bir konferansta veya kokteyl partisinde, telefonunuzun kilit ekranındaki QR kodu veya NFC özellikli kartınızı kullanarak saniyeler içinde bilgilerinizi paylaşabilirsiniz. Karşı tarafın herhangi bir uygulama indirmesine gerek yoktur.</p>

      <h3>İz Bırakın</h3>
      <p>Sadece numaranızı değil; LinkedIn profilinizi, web sitenizi ve hatta takvim randevu linkinizi tek seferde paylaşarak profesyonel imajınızı güçlendirin.</p>
    `
  },
  {
    ...
    author: 'Mehmet Demir',
    content: `
      <p>Her yıl milyarlarca kağıt kartvizit basılıyor ve bunların %88'i bir hafta içinde çöpe atılıyor. Bu israfın önüne geçmek, modern iş dünyasının sorumluluğudur.</p>

      <h3>Kağıtsız Ofis, Kağıtsız Ağ</h3>
      <p>Vialess gibi dijital çözümler kullanarak karbon ayak izinizi azaltabilirsiniz. Tek bir NFC kart, ömür boyu kullanabileceğiniz binlerce kağıt karta bedeldir.</p>

      <h3>Yeşil İmaj</h3>
      <p>Müşterilerinize çevreye duyarlı olduğunuzu göstermenin en pratik yolu, onlara kağıt uzatmak yerine dijital bir çözüm sunmaktır. Bu, markanızın sürdürülebilirlik vizyonunu somutlaştırır.</p>
    `
  },
  {
    ...
    author: 'Elif Yıldız',
    content: `
      <p>NFC (Near Field Communication), yakın alan iletişimi anlamına gelir ve temassız ödeme teknolojisinin aynısını kullanır.</p>

      <h3>Nasıl Çalışır?</h3>
      <p>NFC kartınızın içinde pasif bir çip bulunur. Bu çip, akıllı telefona yaklaştırıldığında (yaklaşık 2-4 cm), içindeki bilgiyi radyo dalgaları yoluyla telefona aktarır. Pil veya şarj gerektirmez.</p>

      <h3>Güvenlik</h3>
      <p>Vialess kartları, sadece sizin belirlediğiniz genel profil linkini paylaşır. Telefonunuzdaki özel verilere erişim sağlamaz, bu da onu tamamen güvenli kılar.</p>
    `
  },
  {
    ...
    author: 'Can Özkan',
    content: `
      <p>Kağıt kartvizit verdiğinizde, o kartın ne zaman görüntülendiğini veya çöpe atılıp atılmadığını asla bilemezsiniz. Dijital dünyada ise her şey ölçülebilir.</p>

      <h3>Tıklama Analizleri</h3>
      <p>Hangi bağlantılarınız daha çok ilgi çekiyor? Instagram mı, LinkedIn mi yoksa Portfolyonuz mu? Bu verilerle profilinizi optimize edebilirsiniz.</p>

      <h3>Coğrafi Veriler</h3>
      <p>Kartınızın hangi şehirlerde veya etkinliklerde daha çok görüntülendiğini takip ederek pazarlama stratejinizi şekillendirebilirsiniz.</p>
    `
  },
  {
    ...
    author: 'Ayşe Şahin',
    content: `
      <p>Hala kağıt kartvizit kullanan müşterilerinizden aldığınız kartları manuel olarak telefonunuza kaydetmek zaman kaybıdır.</p>
      
      <h3>OCR Nedir?</h3>
      <p>Optical Character Recognition (Optik Karakter Tanıma), görseldeki yazıları metne çeviren teknolojidir. Vialess uygulaması ile aldığınız kartın fotoğrafını çekin, yapay zeka tüm bilgileri ayrıştırıp rehberinize kaydetsin.</p>
    `
  },
  {
    ...
    author: 'Cem Arslan',
    content: `
      <p>Büyük şirketlerde networking kopukluğu yaşanabilir. Bir satış temsilcisinin tanıştığı önemli bir kişi, pazarlama ekibi tarafından bilinmiyor olabilir.</p>

      <h3>Merkezi Veritabanı</h3>
      <p>Vialess Business özelliği, tüm ekibinizin topladığı kartvizitleri (izinler dahilinde) ortak bir havuzda görmesini sağlar. Böylece "O şirketten kiminle tanışmıştık?" sorusu tarih olur.</p>
    `
  },
  {
    ...
    author: 'Deniz Koç',
    content: `
      <p>Networking sadece kartvizit dağıtmak değildir; ilişki kurmaktır.</p>
      
      <ul class="list-disc pl-5 space-y-2">
        <li><strong>Dinleyin:</strong> Kendinizi anlatmadan önce karşınızdakini dinleyin.</li>
        <li><strong>Not Alın:</strong> Tanıştığınız kişiyle ilgili küçük notlar alın (dijital kartvizitler buna olanak tanır).</li>
...
export const blogCategories = ['Tümü', 'Teknoloji', 'Networking', 'Sürdürülebilirlik', 'CRM', 'Kurumsal'];