...
export const translations = {
  tr: {
    ...
    faq_a4:
      "Hayır, güvenlik gereği silinen profiller ve ilgili veriler sunucularımızdan kalıcı olarak kaldırılır ve geri getirilemez. Karar vermeden önce verilerinizi yedeklemenizi öneririz.",
  ...
  en: {
    ...
    faq_a1:
      "The SEO indexing process depends on Google algorithms, but results usually start appearing within 1-2 weeks. The completeness of your profile and receiving traffic speed up this process.",
    faq_q2: "Why are application permissions necessary?",
    faq_a2:
      "Vialess requires some permissions to offer you the best experience. For example; contact permission to save people, camera permission to scan business cards, gallery permission to upload profile photo. Your data is protected under GDPR.",
    faq_q3: "Can I temporarily freeze my card?",
    faq_a3:
      'Yes, you can switch your card to "Passive" mode at any time from the Settings or Card Settings section of the application. In this case, those who click your link see a "Maintenance Mode" screen.',
    faq_q4: "Can I recover my profile if I delete it?",
    faq_a4:
