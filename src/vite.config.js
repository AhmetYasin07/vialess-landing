...
// "figma:asset/abc123.png" → "/assets/abc123.png" (public klasöründen)
// -------------------------------------------------------
  ...
  return {
    ...
    resolveId(source) {
      if (source.startsWith('figma:asset/')) {
        ...
        // Dosya varsa doğrudan çöz
        if (fs.existsSync(assetPath)) {
          return assetPath;
        }
        // Dosya yoksa placeholder döndür (build kırılmasın)
    ...
    load(id) {
      if (id.startsWith('\0figma-asset-placeholder:')) {
        ...
        // Placeholder olarak boş SVG data URL döndür
